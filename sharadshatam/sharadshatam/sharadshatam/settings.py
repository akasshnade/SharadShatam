"""
Django settings for sharadshatam project.
...
SECRET_KEY = 'django-insecure-=0$z!e51kz&7c_s*4sl(^^@2%orba%uuoii)^a$h9&0)1c9a*i'
...
WSGI_APPLICATION = 'sharadshatam.wsgi.application'
